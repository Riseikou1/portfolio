...
export default function Home() {
  ...
  return <main>
    ...
    <section className="skills-section wrap"><div className="section-head"><div><p className="section-kicker">TOOLS & THINKING</p><h2>What I work with<span className="period">.</span></h2></div><p>A growing toolkit for practical, thoughtful AI work.</p></div><div className="skill-grid"><div><span>01</span><h3>Build</h3><p>Python, JavaScript, Java, C++, Bash, MySQL</p></div><div><span>02</span><h3>Model</h3><p>PyTorch, scikit-learn, neural networks, transformers</p></div><div><span>03</span><h3>Explore</h3><p>Data processing, research synthesis, computer vision</p></div></div></section>
