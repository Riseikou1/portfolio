...
export default function Contact() {
  return <main>
    <header className="site-header wrap"><Link className="wordmark" href="/" aria-label="Temuujin home"><span className="mark">T<span>.</span></span><span>TEMUUJIN<br /><small>GERELT-OCH</small></span></Link><nav aria-label="Main navigation"><Link href="/#work">Work</Link><Link href="/#about">About</Link><Link href="/#credentials">Credentials</Link></nav><Link className="nav-contact" href="/">Back home <span>↗</span></Link></header>
