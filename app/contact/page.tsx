...
export default function Contact() {
  return <main>
    <header className="site-header wrap"><a className="wordmark" href="/" aria-label="Temuujin home"><span className="mark-wrap"><span className="mark">T</span><span className="mark-dot" /></span><span>TEMUUJIN<br /><small>GERELT-OCH</small></span></a><nav aria-label="Main navigation"><a href="/#work">Work</a><a href="/#about">About</a><a href="/#credentials">Credentials</a></nav><div className="header-right"><ThemeToggle /><a className="nav-contact" href="/">Back home <span>↗</span></a></div></header>
    ...
    <footer className="footer wrap"><span>© {new Date().getFullYear()} TEMUUJIN GERELT-OCH</span><div><a href="/#work">WORK ↗</a><a href="/#credentials">CERTIFICATES ↗</a></div><a href="/">BACK HOME ↑</a></footer>
  </main>;
}
