...
export default function Contact() {
  return <main>
    <header className="site-header wrap"><a className="wordmark" href="/" aria-label="Temuujin home"><img className="site-logo" src="/logo.png" alt="" width="42" height="42" /><span>TEMUUJIN<br /><small>GERELT-OCH</small></span></a><nav aria-label="Main navigation"><a href="/#work">Work</a><a href="/#about">About</a><a href="/#credentials">Credentials</a></nav><div className="header-right"><ThemeToggle /><a className="nav-contact" href="/">Back home <span>↗</span></a></div></header>
